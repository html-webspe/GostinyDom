 ...
 */
    ...
    (() => {
        ...
        const mainHostel = document.querySelector(".main-hostel");
        if (mainHostel) {
        ...
        function initSliders() {
            if (document.querySelector(".vacancies__slider")) new core(".vacancies__slider", {
                ...
                pagination: {
                    el: ".vacancies__slider-pagination",
                    clickable: true
                },
                navigation: {
            ...
            if (document.querySelector(".hostel__slider-wrapper")) {
                const hostelSliderSmall = new core(".hostel__slider-small-inner", {
                    modules: [ Navigation, Manipulation, Lazy ],
                    speed: 700,
                    preloadImages: false,
                    lazy: {
                        loadPrevNext: true
                    ...
                    navigation: {
                        prevEl: ".hostel__slider-arrow-prev",
                        nextEl: ".hostel__slider-arrow-next"
                    },
                    breakpoints: {
                        320: {
                            slidesPerView: 3,
                ...
                new core(".hostel__slider-big", {
                    modules: [ Navigation, Manipulation, Lazy, Thumb ],
                    speed: 1e3,
                    spaceBetween: 0,
                    preloadImages: false,
                    lazy: {
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            const videoSection = document.querySelector(".s-callback");
            if (videoSection) if (!document.documentElement.classList.contains("touch")) videoSection.insertAdjacentHTML("afterbegin", '<video src="img/video.mp4" autoplay loop muted></video>');
        }));
        const checkboxInput = document.querySelectorAll(".checkbox__input");
        if (checkboxInput) checkboxInput.forEach((element => {
            element.addEventListener("change", (function() {
                const th = element;
                const formButton = th.closest("form").querySelector(".button");
                formButton.disabled = true;
                if (th.checked) {
                    formButton.disabled = false;
                    th.closest("form").querySelector(".checkbox__label").classList.remove("_err");
                } else {
                    th.closest("form").querySelector(".checkbox__label").classList.add("_err");
                    formButton.disabled = true;
                }
            }));
        }));
        ...
        const positionFixed = (element, poinst) => {
            window.addEventListener("scroll", (() => {
                ...
                const scrollPos = poinst, elements = document.getElementById(element);
                if (scrollDistens >= scrollPos && window.innerWidth < 768) elements.classList.add("btn-fixed"); else elements.classList.remove("btn-fixed");
            }));
        };
        if (buttonFixed) positionFixed("button-fixed", 600);
        const menuLink = document.querySelector(".menu__link-js");
